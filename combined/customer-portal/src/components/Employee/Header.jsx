	...
	return (
		<header className="z-20 relative flex items-center justify-between w-full border-b border-border-color py-3 px-3 bg-white dark:bg-gray-900 dark:border-gray-700 transition-colors">
			...
			<div className="flex items-center gap-2">
				<button className="max-md:hidden bg-primary-color/80 hover:bg-primary-color text-white rounded-full p-2 transition-colors">
				...
				<button className="max-md:hidden bg-primary-color/70 hover:bg-primary-color text-white rounded-full p-2 transition-colors">
